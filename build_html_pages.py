...
DOCS = [
    ...
    ('librarian output/2026-05-11_meeting-prep_CICC-analyst-question-list.md', 'cicc-list.html',        '卖方分析师交流 — Question List v3',                           '会前 briefing → 会后闭环 · 2026-05-11'),
    ('2026-05-20_FAGB_基于error-log设计的金融领域benchmark原型.md',               'essay-fagb.html',           'FAGB —— 基于 error log 设计的金融领域 benchmark 原型',                     'Essay · 2026-05-20'),
